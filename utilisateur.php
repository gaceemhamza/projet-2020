...
<head>
    ...
    if (isset($_GET['error'])) {
        if ($_GET['error'] == 'empty') {
            ...
            $message = '<div class="alert alert-danger">Les deux mots de passe doit étre identique !</div>';
        }
    }
    ?>
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                ...
                <form style="width: 120%" method="post" action="inscription.php">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="mdpConfirm" class="form-control" placeholder="Confirmer mot de passe"
                               type="password">
                    </div> <!-- form-group// -->
